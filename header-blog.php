...
<header class="contain-to-grid">
	...
	<!-- End of Top-Bar -->
                ...
                <?php
				$display_page_title = get_option('eduking_display_page_title');
				
				if ($display_page_title == "true") {
...
if( is_home() && get_option('page_for_posts') ) {
	...
	echo '<header class="entry-title-box"><h1>'.get_page($blog_page_id)->post_title.'</h1></header>';
}
?>
</div>
