...
<?php if ( have_comments() ) : ?>
	<section id="comments" style="background: #fff; padding: 28px;">
		<h3 style="font-weight: 600; font-size: 20px;"><?php comments_number(__('No Comments', 'reverie'), __('One Comment', 'reverie'), __('% Comments', 'reverie') ); ?></h3><hr>
...
<?php endif; ?>
<?php if ( comments_open() ) : ?>
<section id="respond" style="background: #fff; padding: 28px; margin-top: 18px;">
	<h3 style="font-weight: 600;
font-size: 20px;"><?php comment_form_title( __('Leave a Comment', 'reverie'), __('Leave a Reply to %s', 'reverie') ); ?></h3><hr>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<?php else : ?>
		<p class="commentfield"  style="width: 30%; margin-right: 2%; display: inline-block">
		...
		<p id="allowed_tags" class="small" style="font-size: 12px;"><strong>XHTML:</strong> <?php _e('You can use these tags:','reverie'); ?> <code><?php echo allowed_tags(); ?></code></p>
